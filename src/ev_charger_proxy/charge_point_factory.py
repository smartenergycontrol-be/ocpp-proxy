...
class ChargePointFactory:
    ...
    @staticmethod
    def _detect_version(connection) -> Optional[str]:
        """
        ...
        try:
            ...
            if hasattr(connection, 'subprotocol'):
                ...
                if subprotocol:
                    ...
                    if 'ocpp1.6' in subprotocol_lower:
                        ...
                        return '1.6'
                    elif 'ocpp2.0.1' in subprotocol_lower:
            ...
            if hasattr(connection, 'headers'):
                ...
                if headers:
                    ...
                    if '1.6' in ws_protocol:
                        ...
                        return '1.6'
                    elif '2.0.1' in ws_protocol or '2.0' in ws_protocol:
                    ...
                    if ocpp_version:
                        if '1.6' in ocpp_version:
                            ...
                            return '1.6'
                        elif '2.0.1' in ocpp_version or '2.0' in ocpp_version:
            ...
            if hasattr(connection, 'path'):
                ...
                if 'v1.6' in path or 'ocpp16' in path or '1.6' in path:
                    ...
                    return '1.6'
                elif 'v2.0.1' in path or 'ocpp201' in path or '2.0.1' in path:
                    _LOGGER.debug("Detected OCPP 2.0.1 from URL path")
                    return '2.0.1'
                elif 'v2.0' in path or 'ocpp20' in path:
            ...
            if hasattr(connection, 'query'):
                ...
                if version:
                    if '1.6' in version:
                        ...
                        return '1.6'
                    elif '2.0.1' in version or '2.0' in version:
