...
from ocpp.v201 import ChargePoint as OCPPChargePoint, call_result, call
...
class ChargePointV201(ChargePointBase, OCPPChargePoint):
    ...
    async def on_transaction_event(self, event_type, timestamp, trigger_reason, seq_no, transaction_info, **kwargs):
        ...
        if event_type == 'Started':
            ...
            meter_start = kwargs.get('meter_value', [{}])[0].get('sampled_value', [{}])[0].get('value', 0)
            ...
            meter_stop = kwargs.get('meter_value', [{}])[0].get('sampled_value', [{}])[0].get('value', 0)
